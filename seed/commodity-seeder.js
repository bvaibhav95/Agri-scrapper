{
  /* <option value="137">Ajwan</option>
		...
		<option value="133">Cashewnuts</option>
		...
		<option value="37">Coconut</option>
		...
		<option value="375">Cornation</option>
		...
		<option selected="selected" value="23">Onion</option>
		...
		<option value="2">Paddy(Dhan)</option>
		...
		<option value="21">Pine Apple</option>
...
for (var i = 0; i < commodities.length; i++) {
  commodities[i].save(function(err, result) {
    done++;
    if (done === commodities.length) {
      mongoose.disconnect();
    }
  });
}
